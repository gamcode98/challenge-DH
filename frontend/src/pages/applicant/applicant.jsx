  ...
  return (
    <div>
      <div className='relative'>
        ...
        <div className='p-4 bg-gray-500 w-40 h-40 absolute bottom-[-100px] left-1/2 transform -translate-x-1/2' />
      </div>
      <h2 className='name-applicant font-bold'>
        NOMBRE Y APELLIDO
      </h2>
      ...
      <div class='flow-root rounded-lg border border-gray-100 py-3 shadow-sm mt-10 mb-40'>
        <dl class='-my-3 divide-y divide-gray-100 text-sm'>
          ...
          <div class='grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4'>
            ...
            <dd class='text-gray-700 sm:col-span-2'>ejemplodeemail@gmail.com</dd>
          </div>
